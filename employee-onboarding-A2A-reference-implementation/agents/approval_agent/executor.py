"""
Approval Agent Executor - A2A standard pattern with EventQueue.
"""
...
class ApprovalExecutor(AgentExecutor):
    """Standard A2A executor for Approval Agent using EventQueue."""

    def __init__(self, config: dict = None):
        self.agent = ApprovalAgent(config)
    ...
    async def execute(self, context: RequestContext, event_queue: EventQueue) -> None:
        ...
        logger.info(f"Approval Agent processing: {query[:50]}...")
