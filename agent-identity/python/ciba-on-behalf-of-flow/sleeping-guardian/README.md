...
- [ ] Create a role `stock_mcp` and select created MCP resource server and assign both `stock:read` and `stock:trade` scope and click Finish
- [ ] Assign created `stock_mcp` role to both agent and user
