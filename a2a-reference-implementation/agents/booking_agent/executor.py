"""
Booking Agent Executor - A2A standard pattern with EventQueue.
"""
...
class BookingExecutor(AgentExecutor):
    """Standard A2A executor for Booking Agent using EventQueue."""
    ...
    async def execute(self, context: RequestContext, event_queue: EventQueue) -> None:
        ...
        logger.info(f"Booking Agent processing: {query[:50]}...")
